<?php 
	...
	while($row = mysqli_fetch_assoc($result)) {
		...
		$str1 .='<div class="author"><img class="avatar" src="../images/demo/avatar.png" width="32" height="32" alt="" /><span class="name">'.$row["idUser"].'</span> <span class="wrote">wrote:</span></div>';
		echo $str1;	
		$str1="";
